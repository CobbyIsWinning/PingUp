       ...
       <div className='w-full max-w-md'>
          ...
          style={{backgroundColor: background}}>
               ...
               {mode === 'text' && (
                ...
                p-6 text-lg resize-none focus:outline-none' placeholder="What's on your mind?"
            ...
            <div className='flex gap-2 mt-4'>
             ...
             w-full rounded bg-gradient-to-r from-indigo-500 to-purple-600 hover:from-indigo-600
