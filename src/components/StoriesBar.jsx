...
export const StoriesBar = () => {
  ...
  return (
    <div className='w-screen sm:w-[calc(100vw-240px)] lg:max-w-2x1 no-scrollbar
        ...
        <div className='flex gap-4 pb-5'>
            ...
            border-indigo-300 bg-gradient-to-b from-indigo-50 to-white'>
                <div className='h-full flex flex-col items-center justify-center p-4'>
                   <div className='size-10 bg-indigo-500 rounded-b-full flex items-center
                   justify-center mb-3'>
            ...
            {/* Stories Cards */}
            {
                stories.map((story, index)=>(
                    <div key={index} className={`relative rounded-lg shadow min-w-30 
                    ...
                    <div className='absolute inset-0 z-1 rounded-lg 
                        ...
                        w-full object-cover hover:scale-110 transition duration-500
