            ...
            <div className='max-w-2xl sm:py-6 mx-auto '>
                <div className='bg-white rounded-lg shadow p-6'>
                    ...
                    <form className="space-y-4" onSubmit={handleSaveProfile}>
                        ...
                        bg-black/20 rounded-full items-center justify-center cursor-pointer'>
                    ...
                    <div>
                        ...
                        placeholder='Please enter your full name' onChange={(e) => setEditForm({...editForm, full_name: e.target.value})}
                     ...
                     <div>
                        ...
                        placeholder='Type something about yourself' onChange={(e) => setEditForm({...editForm, bio: e.target.value})}
                        value={editForm.bio} />
                    </div>
                    ...
                    <div className='flex items-center justify-end space-x-3 pt-6'>
                        ...
                        rounded-lg text-gray-700 hover:bg-gray-50 transition-colors cursor-pointer'>Cancel</button>

                        <button 
                        type='submit'
                        className='px-4 py-2 bg-gradient-to-r from-indigo-500
                        to-purple-600 text-white rounded-lg hover:from-indigo-600 hover:to-purple-700 transition cursor-pointer'>Save Changes</button>
                    </div>
